(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    /***/
    function q44p(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function vtpD(module, __webpack_exports__, __webpack_require__) {
      ...
      var _dashboard_model__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../dashboard.model */
      "q44p");

      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(formBuilder, // private dataservice: DataService,
        api, http, router) {
          ...
          this.errorMessage = 'No Account Registered'; // this.loginForm = this._formBuilder.group({
        ...
        _createClass(LoginComponent, [{
          ...
          value: function login() {
            ...
            this.api.login(this.loginModelObj).subscribe(function (res) {
              _this.loginRes = res;
              console.log(res);

              if (res) {
                localStorage.setItem('token', _this.loginRes.token); // localStorage.setItem('isLoggedin', 'true')
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormBuilder"], _shared_api_service__WEBPACK_IMPORTED_MODULE_7__["ApiService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClient"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])], LoginComponent);
      /***/
    }
  }]);
})();
